        ...
        <div class="max-w-2xl w-full">
            <div class="bg-white rounded-2xl shadow-xl p-8 sm:p-12 text-center">
                ...
                <div class="w-24 h-24 bg-red-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    <x-icon name="exclamation-triangle" size="xl" class="text-red-600 w-12 h-12" />
                </div>

                <!-- Error Code -->
                <h1 class="text-6xl sm:text-7xl font-bold text-gray-900 mb-4">404</h1>
                ...
                <div class="mt-8 pt-8 border-t border-gray-200">
                    ...
                    <a href="{{ route('search') }}"
                        class="inline-flex items-center gap-2 text-sacli-green-600 hover:text-sacli-green-700 font-medium text-sm transition-colors">
